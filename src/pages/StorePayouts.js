...
const StorePayouts = () => {
  ...
  return (
    <DashboardLayout title="Store Payouts" subtitle="Manage store payout transactions">
      <div className="mb-6">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Store Payouts</h1>
        <p className="text-sm sm:text-base text-gray-500">Manage store payout transactions</p>
      </div>
